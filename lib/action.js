...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const latestPrereleaseTag = (0, utils_1.getLatestPrereleaseTag)(validTags, tagPrefix, prefixRegex);
        core.info(`latest tag was ${latestTag.name}, latestPrerelease tag was ${latestPrereleaseTag === null || latestPrereleaseTag === void 0 ? void 0 : latestPrereleaseTag.name}.`);
        let commits;
        let newVersion;
        let oldVersion;
        if (customTag) {
